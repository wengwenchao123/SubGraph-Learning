...
# --dataset SD --device cuda:0 --years 2019 --model_name dgcrn --seed 2023 --bs 64
# --dataset PEMS08 --device cuda:0 --model_name dgcrn --seed 2023 --bs 64
def get_config():  #一些基础的参数的设置写在utils/args.py里面
    ...
    parser.add_argument('--cl_decay_step', type=int, default=2000)  #教师学习的步数
    parser.add_argument('--step_size', type=int, default=1500)   #这是多少item后预测步数+1
    parser.add_argument('--tpd', type=int, default=288) #这个应该是指时间间隔，用于这里的DGCRN来换算decoder的时间的
    parser.add_argument('--use_subgraph', type=eval, default=False)
...
def main():
    ...
    # scheduler = None
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[80, 100, 150], gamma=0.5)
