...
class BaseEpochRunner(metaclass=ABCMeta):
    ...
    def __init__(self, cfg: Dict    ) -> None:
        ...
        self.meminfo = 0
        self.handle = pynvml.nvmlDeviceGetHandleByIndex(cfg['GPUS'])
        # support early stopping
    ...
    def train(self, cfg: Dict) -> None:
        ...
        for epoch_index in range(self.start_epoch, self.num_epochs):
            ...
            # meminfo1 = pynvml.nvmlDeviceGetMemoryInfo(self.handle)
            # data loop
            ...
            self.update_epoch_meter('train/GPU Cost', (meminfo.used - self.meminfo.used) / 1024 ** 3)
