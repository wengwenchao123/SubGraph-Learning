...
from model.DG_Cell import DG_Cell
import numpy as np
from collections import OrderedDict
import torch.nn.functional as F

class PM_Encoder(nn.Module):
    def __init__(self, args,node_num, dim_in, dim_out, cheb_k, embed_dim, time_dim, num_layers=1):
        ...
        self.PM_cells.append(DG_Cell(args, node_num, dim_in, dim_out, cheb_k, embed_dim, time_dim))
        for _ in range(1, num_layers):
            self.PM_cells.append(DG_Cell(args, node_num, dim_out, dim_out, cheb_k, embed_dim, time_dim))
...
class DGCNet(nn.Module):
    def __init__(self, args):
        ...
        self.encoder = PM_Encoder(args,args.num_nodes, args.input_dim, args.rnn_units, args.cheb_k,
...
class Parallel_decoder(nn.Module):
    def __init__(self,args=None):
        ...
        self.output_dim = args.output_dim
        self.horizon = args.horizon
        self.decoder = PM_Decoder(args,args.num_nodes, args.input_dim, args.rnn_units, args.cheb_k,
                                  args.embed_dim, args.time_dim, args.num_layers)
        # self.proj = nn.Sequential(nn.Linear(self.hidden_dim, self.output_dim, bias=True))
