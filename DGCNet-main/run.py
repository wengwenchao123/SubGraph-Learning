...
from model.DGCNet import DGCNet as Network
...
args.add_argument('--model', default='DGCNet', type=str)
...
args.add_argument('--indices', type=list)
...
# data_path = os.path.join('data/PEMS08/PEMS08_dtw_partition_true.npy')
# indices = np.load(data_path).squeeze()
# indices =torch.from_numpy(indices)
# args.indices = indices.to(args.device)
