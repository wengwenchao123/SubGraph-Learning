...
class DGCN(nn.Module):
    ...
    def forward(self, x, node_embeddings):
        ...
        #
        #
        selected_nodes_features, batch_indices, indices =self.nodeselection(nodevec1)

        A = DGCN.get_laplacian(F.relu(torch.matmul(selected_nodes_features, selected_nodes_features.transpose(-2, -1))))
