...
class Trainer(object):
    def __init__(self, model, loss, optimizer, train_loader, val_loader, test_loader,
        ...
        self.best_test_path = os.path.join(self.args.log_dir, 'sd.pth')
    ...
    def train_epoch(self, epoch, i=2):
        ...
        self.logger.info(
            '********Train Epoch {}: averaged Loss: {:.6f}, GPU cost: {:.2f} GB, train time: {:.2f} s'.format(epoch,
                                                                                                              train_epoch_loss,
                                                                                                              (meminfo.used - self.meminfo.used) / 1024 ** 3,
