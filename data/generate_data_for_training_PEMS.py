...
def generate_train_val_test(args):
    ...
    if args.dataset == 'PEMS03':
        data_path = os.path.join('PEMS03/PEMS03.npz')
        data = np.load(data_path)['data'][:, :, 0]  #onley the first dimension, traffic flow data
    elif args.dataset == 'PEMS04':
        data_path = os.path.join('PEMS04/PEMS04.npz')
        data = np.load(data_path)['data'][:, :, 0]  #onley the first dimension, traffic flow data
    elif args.dataset == 'PEMS07':
        data_path = os.path.join('PEMS07/PEMS07.npz')
        data = np.load(data_path)['data'][:, :, 0]  #onley the first dimension, traffic flow data
    elif args.dataset == 'PEMS08':
        data_path = os.path.join('PEMS08/PEMS08.npz')
        data = np.load(data_path)['data'][:, :, 0]  #onley the first dimension, traffic flow data
